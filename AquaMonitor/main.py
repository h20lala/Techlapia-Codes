...
def main():
    ...
    # Turbidity
    turb_sensor = TurbiditySensor(config.CHANNEL_TURBIDITY, digital_pin=config.PIN_TURBIDITY_DIGITAL)
    ...
    df = pd.DataFrame(columns=["Timestamp", "Temperature_C", "pH", "Turbidity_NTU", "Turbidity_V", "Turbidity_Digital", "Weight", "WaterLevel"])
    ...
    try:
        while True:
            ...
            turb_digital = turb_sensor.read_digital()
            ...
            table_data = [
                ...
                ["Turbidity", f"{turb_ntu:.2f} NTU (V: {turb_volt:.2f}) [D:{turb_digital}]"],
                ["Weight", f"{weight:.2f}"],
            ...
            new_row = {
                ...
                "Turbidity_Digital": turb_digital,
                "Weight": weight,
            ...
            with open(csv_filename, 'a') as f:
                ...
                line = f"{current_time},{temp_c},{ph_val},{turb_ntu},{turb_volt},{turb_digital},{weight},{level_status}\n"
                f.write(line)
